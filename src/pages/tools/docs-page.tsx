...
export function DocsPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Documentation Generator</h1>
        <p className="text-muted-foreground mt-1">Auto-generate clear, professional documentation from your code using AI.</p>
      </div>

      <GlassCard>
        <h3 className="font-semibold text-foreground mb-4">Code to Document</h3>
        <textarea
          value={code}
          onChange={(e) => setCode(e.target.value)}
          placeholder="Paste a function, class, API endpoint, or module to generate documentation..."
          rows={14}
        ...
        <GlassCard>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-foreground">Generated Documentation</h3>
            </div>
